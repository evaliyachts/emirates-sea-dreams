...
const sanitize = (text: string): string =>
  text
    .replace(/Dubai Yacht/gi, "Dubai Yacht")
    .replace(/\bEvali\b/gi, "Dubai Yacht");
...
const raw: RawService[] = [
  ...
  },
  {
    ...
    description:
      "Plan an unforgettable bachelor party yacht rental in Dubai with Dubai Yacht. Enjoy a private yacht celebration with music, themed decoration, food, drinks, sea views, and a flexible party setup for the groom, bride-to-be, or close friends. A bachelor yacht party in Dubai gives you privacy, space, and an energetic atmosphere while cruising around Dubai Marina, JBR, Bluewaters Island, or Palm Jumeirah. From relaxed daytime gatherings to lively evening parties, we help you create a premium yacht rental experience before the big day.",
    category: "package",
  ...
  },
  {
    ...
    description:
      "Host your engagement or wedding celebration on a luxury yacht in Dubai with Dubai Yacht. Our private yacht rental packages can be customized with romantic decoration, flowers, wedding cake, live music or DJ, catering, photography, and full event coordination. Whether you are planning an intimate engagement, a small wedding party, or a premium sea celebration, a yacht offers privacy, elegance, and unforgettable Dubai skyline views. Celebrate your love story on the water with a luxury yacht experience designed around your style.",
    category: "package",
  ...
  },
  {
    ...
    description:
      "Add a donut ride to your Dubai yacht rental for a fun and energetic water sport experience. Dubai Yacht offers donut rides for friends, families, and groups who want more excitement during their private yacht trip. The inflatable donut is pulled by a speedboat across Dubai's blue waters, giving riders a safe but thrilling adventure. With life jackets, crew support, and speed options, this activity is suitable for both beginners and thrill seekers. It is a perfect add-on for yacht parties, group trips, and sea adventures in Dubai.",
    category: "water sport",
    slug: "donut-ride",
  },
  {

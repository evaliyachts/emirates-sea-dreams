...
- bank transfer, credit card and cash accepted;
- free cancellation up to 48 hours;
- 50% cancellation charge inside 48 hours;
- free rescheduling or full refund for unsafe weather;
...
- Analytics/cookie state and consent requirements.
- Data retention and user-rights contact process.

Until approval, preserve `/terms` and `/privacy` as historical URLs but do not treat the current text as verified or reuse its promises in commercial content, FAQs, schema or offers.

# English PR 8B Owner Approval

Approval date: **2026-07-14**  
Approver: **Business owner**  
Domain: `https://yachtrentaldxb.com/`
...
> Departure location varies by yacht and confirmed booking. Dubai Marina may be used as a general departure reference, but it is not presented as the company’s business address or as a guaranteed departure point.

## Route and behavior decisions

- `/about`, `/faq`, `/contact`, `/terms` and `/privacy`: publish as indexable self-canonical owners.
- `/offers`: remain a real 404; remove visible links; no redirect.
- Expected PR 8B publication and sitemap count: **38**.
- Approved redirects and consolidations: **0**.
- Live `hreflang`, `x-default`, analytics and Search Console actions: **not approved**.
- The contact form runs only in the browser, prepares WhatsApp, collects no name/phone/email, and must provide a truthful blocked-popup fallback.
